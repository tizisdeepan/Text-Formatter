...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.bold.setOnCheckedChangeListener { buttonView, isChecked ->
            binding.formattedEditText.isBoldSpan = isChecked
            binding.formattedEditText.setStyleForSelection(
                binding.bold.isChecked,
                binding.italic.isChecked,
                binding.underline.isChecked,
                binding.strike.isChecked,
                binding.bullet.isChecked,
                binding.number.isChecked
            )
        }

        binding.italic.setOnCheckedChangeListener { buttonView, isChecked ->
            binding.formattedEditText.isItalicSpan = isChecked
